# Apres Installation - AWS Bootstrap
...
* An AWS Organization with a standard Organization Unit (OU) structure.
* AWS sub-accounts for development, staging, and production along with
  accounts for security and audit.
* A root AWS account with multi-factor authentication (MFA) enabled.
* Integration with your Identity Provider (IDP) for Single Sign-On (SSO).
* IAM accounts with administrator access for on-going administration.

This will prepare you for the next step: Apres Installation - Foundations.
