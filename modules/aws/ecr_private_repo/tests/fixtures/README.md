# ECR Private Repo Example

This is an example on how to deploy the ECR Private Repo, used by the integration tests.
...
1. `cd test`
1. `dep ensure`
1. `AWS_PROFILE=<some-predefined-profile> go test -v -run TestEcrPrivateRepo
