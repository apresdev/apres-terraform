...
| <a name="module_landlord_api_gateway"></a> [landlord\_api\_gateway](#module\_landlord\_api\_gateway) | git@github.com:apresdev/apres-terraform.git//modules/aws/api_gateway_rest | rel/api_gateway_rest/1.2.1 |
...
| [aws_secretsmanager_secret.secure_cookie_key](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/secretsmanager_secret) | resource |
| [aws_secretsmanager_secret_version.secure_cookie_key](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/secretsmanager_secret_version) | resource |
| [random_bytes.secure_cookie_key](https://registry.terraform.io/providers/hashicorp/random/latest/docs/resources/bytes) | resource |
...
| <a name="input_ecs_api_max_instances"></a> [ecs\_api\_max\_instances](#input\_ecs\_api\_max\_instances) | Maximum number of ECS running tasks for API | `number` | `5` | no |
| <a name="input_ecs_api_min_instances"></a> [ecs\_api\_min\_instances](#input\_ecs\_api\_min\_instances) | Minimum number of ECS running tasks for API | `number` | `1` | no |
| <a name="input_ecs_console_max_instances"></a> [ecs\_console\_max\_instances](#input\_ecs\_console\_max\_instances) | Maximum number of ECS running tasks for Console | `number` | `5` | no |
| <a name="input_ecs_console_min_instances"></a> [ecs\_console\_min\_instances](#input\_ecs\_console\_min\_instances) | Minimum number of ECS running tasks for Console | `number` | `1` | no |
...
| <a name="input_invite_email_template_filename"></a> [invite\_email\_template\_filename](#input\_invite\_email\_template\_filename) | Filename for the invite Email template. If not provided, a simple one line message<br/>will appear in the invite email. | `string` | `""` | no |
| <a name="input_name"></a> [name](#input\_name) | Name used to create resources | `string` | n/a | yes |
| <a name="input_override_user_pool_client_name"></a> [override\_user\_pool\_client\_name](#input\_override\_user\_pool\_client\_name) | If set, the name of the user pool client will be set to this value. If not set, the name will be<br/>        generated based on the environment and application name. | `string` | `""` | no |
| <a name="input_override_user_pool_name"></a> [override\_user\_pool\_name](#input\_override\_user\_pool\_name) | If set, the name of the user pool will be set to this value. If not set, the name will be<br/>        generated based on the environment and application name. | `string` | `""` | no |
...
| <a name="input_tenant_profile_fields"></a> [tenant\_profile\_fields](#input\_tenant\_profile\_fields) | List of profile field definitions for tenants | <pre>list(object({<br/>    name                    = string<br/>    ui_name                 = string<br/>    format                  = string<br/>    max_len                 = number<br/>    min_len                 = number<br/>    prevent_empty           = optional(bool, false)<br/>    regex_validator         = optional(string, "")<br/>    invite_time_field       = optional(bool, false)<br/>    possible_values_url     = optional(string, "")<br/>    possible_values_jq_expr = optional(string, "")<br/>  }))</pre> | `[]` | no |
| <a name="input_user_profile_fields"></a> [user\_profile\_fields](#input\_user\_profile\_fields) | List of profile field definitions for users | <pre>list(object({<br/>    name                    = string<br/>    ui_name                 = string<br/>    format                  = string<br/>    max_len                 = number<br/>    min_len                 = number<br/>    prevent_empty           = optional(bool, false)<br/>    regex_validator         = optional(string, "")<br/>    invite_time_field       = optional(bool, false)<br/>    possible_values_url     = optional(string, "")<br/>    possible_values_jq_expr = optional(string, "")<br/>  }))</pre> | `[]` | no |
