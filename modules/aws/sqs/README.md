...
the SQS queue name will be `SystemTest-mytestqueue`
...
| <a name="input_name"></a> [name](#input\_name) | Name of the queue, must be more than 2 and less than 65 characters<br/>    long and can contain only the following characters: a-z, A-Z, 0-9, \_, and - | `string` | n/a | yes |
