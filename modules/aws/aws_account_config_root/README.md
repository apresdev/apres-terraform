...
* Enables centralized root user access
...
[AWS account root user](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_root-user.html) documentation for
details on how to temporarily request root credentials for one of your AWS accounts.
...
- Sid: AllowManageIAMPasswordPolicy
  ...
  Action:
    - iam:*PasswordPolicy
  Resource: "*"
- Sid: AllowCentralRootUserManagment
  Effect: Allow
  Action:
...
| [aws_iam_organizations_features.example](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_organizations_features) | resource |
