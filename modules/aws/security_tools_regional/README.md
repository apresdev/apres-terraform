...
| <a name="input_enable_eks_protection"></a> [enable\_eks\_protection](#input\_enable\_eks\_protection) | Enable GuardDuty to monitor EKS clusters | `bool` | `true` | no |
| <a name="input_enable_lambda_protection"></a> [enable\_lambda\_protection](#input\_enable\_lambda\_protection) | Enable GuardDuty to monitor Lambda functions | `bool` | `true` | no |
| <a name="input_enable_rds_protection"></a> [enable\_rds\_protection](#input\_enable\_rds\_protection) | Enable GuardDuty to monitor RDS instances | `bool` | `true` | no |
| <a name="input_enable_s3_protection"></a> [enable\_s3\_protection](#input\_enable\_s3\_protection) | Enable GuardDuty to monitor S3 buckets | `bool` | `true` | no |
