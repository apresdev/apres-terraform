...
data "aws_iam_policy_document" "cloudfront" {
  ...
  source_policy_documents = var.replication_source_config.enabled ? [module.s3.default_bucket_policy, module.s3.replication_bucket_policy] : [module.s3.default_bucket_policy]
}
