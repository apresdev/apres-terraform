...
| <a name="module_s3"></a> [s3](#module\_s3) | git@github.com:apresdev/apres-terraform.git//modules/aws/s3 | rel/s3/3.1.0 |
| <a name="module_s3_logs"></a> [s3\_logs](#module\_s3\_logs) | git@github.com:apresdev/apres-terraform.git//modules/aws/s3 | rel/s3/3.0.1 |
