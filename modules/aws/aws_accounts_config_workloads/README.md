...
also creates an S3 bucket for Load Balancer access logs, by default keeping access logs for 365 days.
...
| <a name="module_load_balancer_logs_bucket"></a> [load\_balancer\_logs\_bucket](#module\_load\_balancer\_logs\_bucket) | ../s3 | n/a |
...
| <a name="input_retain_load_balancer_logs_days"></a> [retain\_load\_balancer\_logs\_days](#input\_retain\_load\_balancer\_logs\_days) | Number of days to retain the load balancer logs. By default, this is set to 365.<br>    Setting this to -1 will retain logs indefinitely. | `number` | `365` | no |
