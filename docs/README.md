...
NOTE: These docs should be moved to a public site at some point in the future.

## Table of Contents

* [Getting Started with Apres - Prerequisites](./getting-started-prerequisites.md)
* [Getting Started with Apres - Part 1 - AWS Bootstrap](./getting-started-part-1-aws-bootstrap.md) - Details how to setup an AWS Organization with Control Tower in preparation for part 2.
* [Getting Started with Apres - Part 2 - Apres Keystone](./keystone.md) - Outlines how to get started with Apres Keystone
